  ...
  return (
    <NavigationContainer>
      <Tab.Navigator barStyle={{ backgroundColor: '#f9f9f9' }}>
        <Tab.Screen name="Home" options={{tabBarLabel:() => {return null}, tabBarIcon:()=>(<AntDesign name="home" size={24} color="black" />)}} component={Homepage} />
        <Tab.Screen name="Search" options={{tabBarLabel:() => {return null}, tabBarIcon:()=>(<AntDesign name="home" size={24} color="black" />)}} component={Homepage} />
