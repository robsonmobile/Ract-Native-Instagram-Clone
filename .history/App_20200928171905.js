  ...
  return (
    <NavigationContainer>
      <Tab.Navigator barStyle={{ backgroundColor: '#f9f9f9' }}>
        ...
        <Tab.Screen name="Camera" options={{tabBarLabel:() => {return null}, tabBarIcon:()=>(<AntDesign name="plussquareo" size={24} color="black" />)}} component={Homepage} />
        <Tab.Screen name="Heard" options={{tabBarLabel:() => {return null}, tabBarIcon:()=>(<AntDesign name="hearto" size={24} color="black" />)}} component={Homepage} />
