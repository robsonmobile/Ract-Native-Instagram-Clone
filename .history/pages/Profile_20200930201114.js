...
const Profile = ({ route, navigation }) => {
  const username = route.params ? route.params.username : "safak";
  // const array = username ? otherUserPostArray : currentUserPostArray;
  // console.log(username && username)
  console.log(username)
  const array =otherUserPostArray
  return (
    <View style={styles.profile}>
      <Nav navigation={navigation} title="asd" />
      <ScrollView>
        <View style={styles.profileUser}>
          <Image
            style={styles.profilePicture}
            source={{
              uri: "https://images.pexels.com/photos/428321/pexels-photo-428321.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
            }}
            resizeMode={"cover"}
          />
        ...
        <GridPosts navigation={navigation} posts={array} />
      </ScrollView>
    </View>
  );
};
