...
const Profile = ({ route, navigation }) => {
  ...
  const array =
    username === "safak" ? currentUserPostArray : otherUserPostArray;
  return (
    <View style={styles.profile}>
      <Nav navigation={navigation} title={username} />
      {/* <ScrollView> */}
        ...
        <View style={styles.profileUserDesc}>
          <Text style={styles.profileUserDescName}>
            {username === "safak" ? "Safak Kocaoglu" : "John Arne Riise"}
          </Text>
